...
import com.AirBnd.AirBnB_backend.entities.*;
...
import com.AirBnd.AirBnB_backend.repository.*;
import com.AirBnd.AirBnB_backend.service.interfaces.BookingService;
import com.AirBnd.AirBnB_backend.service.interfaces.CheckoutService;
import com.AirBnd.AirBnB_backend.strategy.PricingService;
...
public class BookingServiceImpl implements BookingService {
                ...
                bookingRepository.findByPaymentSessionId(sessionId)
                        .orElseThrow(() ->
                                new ResourceNotFoundException(
                                        "Booking not found for session ID: "
                                                + sessionId));
    ...
    public BookingStatus getBookingStatus(Long bookingId) {
        log.info("Getting status for booking: {}", bookingId);
        ...
        // No user check! Browser redirect has no token!
    }
    @Override
