...
public interface InventoryRepository extends JpaRepository<InventoryEntity,Long> {
    ...
    SET i.price = :basePrice
    WHERE i.room.id = :roomId
    AND i.date >= :today
    """)
    void updateFutureInventoryPrices(
            @Param("roomId") Long roomId, // Only update FUTURE dates!
            @Param("basePrice") BigDecimal basePrice,
            @Param("today") LocalDate today  // Past inventory prices should stay as they were
            // (for booking records accuracy)
